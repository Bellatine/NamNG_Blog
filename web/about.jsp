<%-- 
    Document   : about
    Created on : 9 thg 1, 2024, 16:36:22
    Author     : namng
--%>
...
<head>
	...
	<link href="//fonts.googleapis.com/css2?family=Source+Sans+Pro&display=swap" rel="stylesheet"> <!-- https://fonts.google.com/ -->
        ...
        <main class="tm-main">
            ...
            <div class="row tm-row tm-mb-45">
                <div class="col-12">
                    ...
                    <img src="./jsp/img/about-01.jpg" alt="Image" class="img-fluid">
                </div>
            </div>
            ...
            <div class="row tm-row tm-mb-60">
                ...
                <div class="col-lg-6 tm-mb-60 tm-person-col">
                    <div class="media tm-person">
                        <img src="./jsp/img/about-03.jpg" alt="Image" class="img-fluid mr-4">
                        <div class="media-body">
                ...
                <div class="col-lg-6 tm-mb-60 tm-person-col">
                    <div class="media tm-person">
                        <img src="./jsp/img/about-05.jpg" alt="Image" class="img-fluid mr-4">
                        <div class="media-body">
