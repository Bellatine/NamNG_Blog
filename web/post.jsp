<%-- 
    Document   : post
    Created on : 9 thg 1, 2024, 16:39:22
    Author     : admin
--%>
...
<head>
	...
	<link rel="stylesheet" href="./jsp/fontawesome/css/all.min.css"> <!-- https://fontawesome.com/ -->
	<link href="https://fonts.googleapis.com/css2?family=Source+Sans+Pro&display=swap" rel="stylesheet"> <!-- https://fonts.google.com/ -->
    <link href="./jsp/css/bootstrap.min.css" rel="stylesheet">
    <link href="./jsp/css/templatemo-xtra-blog.css" rel="stylesheet">
<!--
...
<body>
        ...
        <div class="tm-header-wrapper">
            ...
            <nav class="tm-nav" id="tm-nav">            
                <ul>
                    ...
                    <li class="tm-nav-item active"><a href="post.jsp" class="tm-nav-link">
            ...
            <div class="row tm-row">
                <div class="col-12">
                    ...
                    <video width="954" height="535" controls class="tm-mb-40">
                        <source src="./jsp/video/wheat-field.mp4" type="video/mp4">							  
                        ...
                        <div>
                            ...
                            <div class="tm-comment tm-mb-45">
                                <figure class="tm-comment-figure">
                                    <img src="./jsp/img/comment-1.jpg" alt="Image" class="mb-2 rounded-circle img-thumbnail">
                            ...
                            <div class="tm-comment-reply tm-mb-45">
                                ...
                                <div class="tm-comment">
                                    <figure class="tm-comment-figure">
                                        <img src="./jsp/img/comment-2.jpg" alt="Image" class="mb-2 rounded-circle img-thumbnail">
    ...
    <script src="./jsp/js/templatemo-script.js"></script>
</body>
</html>